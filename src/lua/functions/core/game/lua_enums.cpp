...
void LuaEnums::initConditionParamEnums(lua_State* L) {
	...
	registerEnum(L, CONDITION_PARAM_ONSLAUGHT_CHANCE);
	registerEnum(L, CONDITION_PARAM_MOMENTUM_CHANCE);
	registerEnum(L, CONDITION_PARAM_TRANSCENDENCE_CHANCE);
	registerEnum(L, CONDITION_PARAM_AMPLIFICATION_CHANCE);
	registerEnum(L, CONDITION_PARAM_RUSE_CHANCE);
