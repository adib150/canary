...
VARIABLEMANALEECH = 2      -- +0.02 mana leech amount
VARIABLELIFELEECH = 2      -- +0.02 life leech amount
VARIABLESHIELD = 0.1         -- +0.1 shield skill
VARIABLEONSLAUGHT = 0.05      -- +0.05 onslaught chance
VARIABLEMOMENTUM = 0.05         -- +0.05 momentum chance
VARIABLETRANSCENDENCE = 0.05    -- +0.05 transcendence chance
VARIABLEAMPLIFICATION = 0.05    -- +0.05 amplification chance

-- Default baseline for bonuses; kept empty so only configured bonuses are applied
DEFAULT_CONDITIONS = {}
...
local CONDITION_TO_VARIABLE = {
	...
	[CONDITION_PARAM_ONSLAUGHT_CHANCE] = 'VARIABLEONSLAUGHT',
	[CONDITION_PARAM_MOMENTUM_CHANCE] = 'VARIABLEMOMENTUM',
	[CONDITION_PARAM_TRANSCENDENCE_CHANCE] = 'VARIABLETRANSCENDENCE',
	[CONDITION_PARAM_AMPLIFICATION_CHANCE] = 'VARIABLEAMPLIFICATION'
}
...
local FULL_BONUSES_TEMPLATE = {
	...
	[CONDITION_PARAM_ONSLAUGHT_CHANCE] = { value = VARIABLEONSLAUGHT },
	[CONDITION_PARAM_MOMENTUM_CHANCE] = { value = VARIABLEMOMENTUM },
	[CONDITION_PARAM_TRANSCENDENCE_CHANCE] = { value = VARIABLETRANSCENDENCE },
	[CONDITION_PARAM_AMPLIFICATION_CHANCE] = { value = VARIABLEAMPLIFICATION }
}
