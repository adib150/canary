	...
	-- Consumables ~ Power Sockets
	{
		...
		offers = {
			...
			},
			{
				...
				name = "Surprise Upgrade Powder",
				price = 110,
				itemtype = 6571,
				count = 1,
				description = "<i>Contains a random socket upgrade powder for equipments class 3 and 4!</i>\n\n<i>Contem um po de upgrade de soquete aleatorio para equipamentos classe 3 e 4!</i>\n\n{character}\n{storeinbox}\n{capacity}",
				type = GameStore.OfferTypes.OFFER_TYPE_STACKABLE,
			},
			{
				icons = { "Surprise_Powder_of_Power.png" },
			...
			},
			{
				...
				name = "Surprise Socket Removal",
				price = 110,
				itemtype = 6570,
				count = 1,
				description = "<i>Contains a random socket removal powder!</i>\n\n<i>Contem um po de remocao de soquete aleatorio!</i>\n\n{character}\n{storeinbox}\n{capacity}",
				type = GameStore.OfferTypes.OFFER_TYPE_STACKABLE,
			},
			{
				icons = { "Surprise_Removal_of_Slot.png" },
