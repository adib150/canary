...
GameStore.Categories = {
	...
	-- Exclusives
	{
		...
		offers = {
			...
			{
				icons = { "Random_Outfit_Or_Addon_Doll.png" },
				name = "A Random Outfit or Addon doll",
				price = 110,
				itemtype = 50343,
				count = 1,
				movable = true,
				description = "<i>Used to get a random outfit or addon.</i>\n\n<i>Usado para obter uma outfit ou addon aleatorio.</i>\n\n{character}\n{storeinbox}\n{capacity}",
				type = GameStore.OfferTypes.OFFER_TYPE_STACKABLE,
			},
			{
				icons = { "Random_Outfit_Or_Addon_Doll.png" },
			...
			{
				name = "InsomniaOt Teleporter",
				price = 900,
				itemtype = 31633,
				count = 1,
				description = "<i>Teleports you to bosses and cities even with battle.</i>\n\n<i>Teleporta você para chefes e cidades mesmo em batalha.</i>\n\n{character}\n{storeinbox}\n{once}\n{useicon} use para abrir\n{info} sempre colocado na primeira posicao da sua Store inbox",
				type = GameStore.OfferTypes.OFFER_TYPE_ITEM_UNIQUE,
			}
		},
	},
	--Equipables
	{
		...
		offers = {
			{
				icons = { "Empty_Mortal_Soul.png" },
				name = "Empty Mortal Soul",
				price = 1000,
				itemtype = 50345,
				count = 1,
				movable = true,
			...
			{
				icons = { "Knowledge_For_Mortal_Soul.png" },
				name = "Knowledge For Mortal Soul",
				price = 1000,
				itemtype = 50354,
				count = 1,
				movable = true,
				description = "<i>A scroll of knowledge that upgrades your Mortal Soul until it becomes an Angel soul.</i>",
				type = GameStore.OfferTypes.OFFER_TYPE_STACKABLE,
			},
			{
				icons = { "Knowledge_For_Angel_Soul.png" },
				name = "Knowledge For Angel Soul",
				price = 1000,
				itemtype = 50355,
				count = 1,
				movable = true,
				description = "<i>A scroll of knowledge that upgrades your Angel Soul until it becomes a Celestial soul.</i>",
				type = GameStore.OfferTypes.OFFER_TYPE_STACKABLE,
			},
			{
				icons = { "Knowledge_For_Celestial_Soul.png" },
				name = "Knowledge For Celestial Soul",
				price = 1000,
				itemtype = 50367,
				count = 1,
				movable = true,
				description = "<i>A scroll of knowledge that upgrades your Celestial Soul until it becomes an Ascendant soul.</i>",
				type = GameStore.OfferTypes.OFFER_TYPE_STACKABLE,
			},
			{
				icons = { "Knowledge_For_Ascendant_Soul.png" },
				name = "Knowledge For Ascendant Soul",
				price = 1000,
				itemtype = 50356,
				count = 1,
				movable = true,
				description = "<i>A scroll of knowledge that upgrades your Ascendant Soul until it becomes a Godhood soul.</i>",
				type = GameStore.OfferTypes.OFFER_TYPE_STACKABLE,
			},
			{
				icons = { "Knowledge_For_Godhood_Soul.png" },
				name = "Knowledge For Godhood Soul",
				price = 1000,
				itemtype = 50368,
				count = 1,
				movable = true,
				description = "<i>A scroll of knowledge that upgrades your Godhood Soul.</i>",
				type = GameStore.OfferTypes.OFFER_TYPE_STACKABLE,
			},
		},
	},
	...
	-- Consumables
	{
		...
		name = "Consumables",
		rookgaard = true,
		subclasses = { "Blessings", "Casks", "Exercise Weapons", "Kegs", "Potions", "Runes", "Power Sockets" },
	},
